...
// FindValidDirectory iterates through a list of directory paths and returns the first one that exists on the filesystem. If none of the directories exist, it returns an error.
...
// FindValidFile iterates through a list of file paths and returns the first one that exists on the filesystem. If none of the files exist, it returns an error.
