...
func (hs *heartShape) DrawFinder(ctx *standard.DrawContext) {
	_ = hs // currently no specific state needed, but can be used for future enhancements
...
func (es *emojiShape) DrawFinder(ctx *standard.DrawContext) {
	_ = es // currently no specific state needed, but can be used for future enhancements
