...
type Admin struct {
	...
	LoginAttempts   int        `gorm:"column:LoginAttempts" json:"LoginAttempts"`
	MaxRetry        int        `gorm:"column:MaxRetry;default:5" json:"MaxRetry"`
	LockUntil       *time.Time `gorm:"column:LockUntil" json:"LockUntil"`
	LastFailedLogin *time.Time `gorm:"column:LastFailedLogin" json:"LastFailedLogin"`
}
