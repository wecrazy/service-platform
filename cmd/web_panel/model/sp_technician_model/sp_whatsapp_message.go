...
type SPWhatsAppMessage struct {
	ID uint `gorm:"primaryKey;autoIncrement" json:"id"`
	gorm.Model

	TechnicianGotSPID *uint `gorm:"column:technician_got_sp_id" json:"technician_got_sp_id"`
	SPLGotSPID        *uint `gorm:"column:spl_got_sp_id" json:"spl_got_sp_id"`
	SACGotSPID        *uint `gorm:"column:sac_got_sp_id" json:"sac_got_sp_id"`

	WhatSP     string `gorm:"column:what_sp;type:varchar(50)" json:"what_sp"` // values: SP_TECHNICIAN, SP_SPL, SP_SAC
