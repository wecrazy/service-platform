...
type TechnicianGotSP struct {
	...
	WhatsappMessages    []SPWhatsAppMessage `gorm:"foreignKey:TechnicianGotSPID" json:"-"`
	SP1WhatsappMessages []SPWhatsAppMessage `gorm:"foreignKey:TechnicianGotSPID;where:number_of_sp = 1" json:"sp1_whatsapp_messages"`
	SP2WhatsappMessages []SPWhatsAppMessage `gorm:"foreignKey:TechnicianGotSPID;where:number_of_sp = 2" json:"sp2_whatsapp_messages"`
	SP3WhatsappMessages []SPWhatsAppMessage `gorm:"foreignKey:TechnicianGotSPID;where:number_of_sp = 3" json:"sp3_whatsapp_messages"`
...
func (TechnicianGotSP) TableName() string {
	return config.WebPanel.Get().SPTechnician.TBTechGotSP
}
