...
func RenderDataTableServerSideSPTechnician(title, table_name, endpoint string, page_length int, length_menu []int, order []any, table_columns []Column, insertable, editable, deletable, hideHeader, passwordable bool, scrollUpDown, scrollLeftRight bool, exportType []string, db *gorm.DB) template.HTML {
	...
	for i, col := range table_columns {
		...
		case "string":
			allowedCols := map[string]bool{
				...
				"name":       true,
				// "for_project":                 true,
				"pelanggaran_sp1": true,
				"pelanggaran_sp2": true,
				"pelanggaran_sp3": true,
				"sp1_sent_to":     true,
				"sp2_sent_to":     true,
				"sp3_sent_to":     true,
				// "sp1_whatsapp_chat_id":        true,
				// "sp2_whatsapp_chat_id":        true,
				// "sp3_whatsapp_chat_id":        true,
				// "sp1_whatsapp_chat_jid":       true,
				// "sp2_whatsapp_chat_jid":       true,
				// "sp3_whatsapp_chat_jid":       true,
				// "sp1_whatsapp_sender_jid":     true,
				// "sp2_whatsapp_sender_jid":     true,
				// "sp3_whatsapp_sender_jid":     true,
				"sp1_whatsapp_message_body": true,
				"sp2_whatsapp_message_body": true,
				"sp3_whatsapp_message_body": true,
				"sp1_whatsapp_message_type": true,
				"sp2_whatsapp_message_type": true,
				"sp3_whatsapp_message_type": true,
				// "sp1_whatsapp_quoted_msg_id":  true,
				// "sp2_whatsapp_quoted_msg_id":  true,
				// "sp3_whatsapp_quoted_msg_id":  true,
				"sp1_whatsapp_reply_text":     true,
				"sp2_whatsapp_reply_text":     true,
				"sp3_whatsapp_reply_text":     true,
				"sp1_whatsapp_reaction_emoji": true,
				"sp2_whatsapp_reaction_emoji": true,
				"sp3_whatsapp_reaction_emoji": true,
				// "sp1_whatsapp_mentions":       true,
				// "sp2_whatsapp_mentions":       true,
				// "sp3_whatsapp_mentions":       true,
				"sp1_whatsapp_status":     true,
				"sp2_whatsapp_status":     true,
				"sp3_whatsapp_status":     true,
				"sp1_whatsapp_replied_by": true,
				"sp2_whatsapp_replied_by": true,
				"sp3_whatsapp_replied_by": true,
				"sp1_whatsapp_reacted_by": true,
				"sp2_whatsapp_reacted_by": true,
				"sp3_whatsapp_reacted_by": true,
				"sp1_sound_tts_path":      true,
				"sp2_sound_tts_path":      true,
				"sp3_sound_tts_path":      true,
				"sp1_file_path":           true,
				"sp2_file_path":           true,
				"sp3_file_path":           true,
			}
		...
		case "bool":
			allowedCols := map[string]bool{
				...
				"is_got_sp2":       true,
				"is_got_sp3":       true,
				"sp1_sound_played": true,
				"sp2_sound_played": true,
				"sp3_sound_played": true,
			}
...
`
	...
	renderedHTML, err := RenderTemplateToString("gui_server_table_sp_technician.html", map[string]any{
...
func RenderDataTableServerSideSPSPL(title, table_name, endpoint string, page_length int, length_menu []int, order []any, table_columns []Column, insertable, editable, deletable, hideHeader, passwordable bool, scrollUpDown, scrollLeftRight bool, exportType []string, db *gorm.DB) template.HTML {
	var column_array []int
	for i, col := range table_columns {
		if col.Visible {
			column_array = append(column_array, i)
...
`
	...
	renderedHTML, err := RenderTemplateToString("gui_server_table_sp_spl.html", map[string]any{
		"title":           template.HTML(title),
		"table_name":      table_name,
		"endpoint":        template.URL(endpoint),
		"table_columns":   table_columns,
...
func RenderDataTableServerSideSPSAC(title, table_name, endpoint string, page_length int, length_menu []int, order []any, table_columns []Column, insertable, editable, deletable, hideHeader, passwordable bool, scrollUpDown, scrollLeftRight bool, exportType []string, db *gorm.DB) template.HTML {
	var column_array []int
	for i, col := range table_columns {
		if col.Visible {
			column_array = append(column_array, i)
...
`
	...
	renderedHTML, err := RenderTemplateToString("gui_server_table_sp_sac.html", map[string]any{
		"title":           template.HTML(title),
		"table_name":      table_name,
		"endpoint":        template.URL(endpoint),
		"table_columns":   table_columns,
