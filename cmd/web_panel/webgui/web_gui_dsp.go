...
func RenderDataTableServerSideTicketDSP(title, table_name, endpoint string, page_length int, length_menu []int, order []any, table_columns []Column, insertable, editable, deletable, hideHeader, passwordable bool, scrollUpDown, scrollLeftRight bool, exportType []string, db *gorm.DB) template.HTML {
...
`
	...
	renderedHTML, err := RenderTemplateToString("gui_server_table_data_ticket_dsp.html", map[string]any{
