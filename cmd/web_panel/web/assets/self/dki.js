async function refreshDataTicketDKI(endpoint, btnClass, tbClass, lastUpdateClass) {
  const $btn = $("." + btnClass);
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          GetLastUpdateDataTicketDKI(lastUpdateEndpoint, lastUpdateClass);
        },
...
function GetLastUpdateDataTicketDKI(endpoint, lastUpdateClass) {
  $.ajax({
    url: endpoint,
    type: 'GET',
    dataType: 'json',
...
function downloadExcelReportAllDKITicket(userID, endpoint, request) {
  ...
  let localStorageFilters = localStorage.getItem('datatableFiltersTicketDKI');
