L.Control.FeatureLegend = L.Control.extend({
    ...
    _buildTitle: function () {
        if (this.options.title) {
            let title = L.DomUtil.create('h4', 'leaflet-control-feature-legend-title', this._contents);
    ...
    _layerIsSupported: function (layer) {
        return (layer instanceof L.CircleMarker || layer instanceof L.Circle || layer instanceof L.Marker);
    },
